...
class EstimationCreate(BaseModel):
    ...
    # Pipeline selection — standard fixed flow, ACB loop, or manual agentic loop.
    estimation_mode: Literal["standard", "acb", "agentic"] = "standard"
    acb_max_iterations: int = Field(
        default=2,
        ge=0,
        le=3,
        description="Maximum ACB re-iteration cycles (0–3). Ignored outside acb mode.",
    )
