...
class BaseLLMService(ABC):
    ...
    def __init__(self) -> None:
        ...
        self._stream_partial: dict[str, Any] | None = None
    ...
    def _finalize_turn(
        ...
        *,
        ...
        model_info: dict[str, Any] = ctx["model_info"]
    ...
    async def _call_and_parse(self, ctx: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            log.error("provider_error", error_type=exc.type, message=exc.message)
            raise
