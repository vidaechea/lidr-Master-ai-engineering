...
Three roles with structurally distinct objectives:
    - Actor: generates the candidate estimate.
    - Critic: audits the candidate against explicit criteria and returns typed issues.
    - Boss: makes the governance decision with an explicit iteration budget cap.

Anti-patterns avoided:
    - Distinct prompts per role to avoid objective collapse.
    - Critic output is always structured (CriticFeedback schema), never free text.
    - Boss operates with a hard budget and avoids unbounded iteration.
"""
