...
if TYPE_CHECKING:
    from app.generation.conversation.summarizer_service import SummarizerService
    ...
    def to_messages_list(self, system_prompt: str | None = None) -> list[dict[str, str]]:
        ...
        Args:
            system_prompt: A freshly rendered system prompt string (e.g. built
                by :class:`~app.foundation.prompts.prompt_builder.PromptBuilder`
                with the current :class:`~app.generation.conversation.sessions.ProjectMetadata`).
