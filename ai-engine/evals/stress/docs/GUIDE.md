...
# evals/stress/results/aggregated.json
```
...
pytest evals/stress/tests/test_stress_scenarios.py::test_project_growth_scenario -v

# Todos los escenarios
pytest evals/stress/tests/ -m "slow and llm_live" -v

# Solo unidad (sin LLM live)
pytest evals/stress/tests/ -m "not llm_live" -v
```
...
pytest evals/stress/tests/ -m slow --json stress_report.json
```
...
Todos los resultados se guardan en `evals/stress/results/`:

```bash
ls -la evals/stress/results/
